...
sidebar_position: 1
---
# <span style="font-size: 2.5rem; font-weight: bold; color: #333;" class="leading-loose">Default Benchmark</span>
<br />

## <span style="font-size: 1.8rem; font-weight: bold; color: #333;">LAMM-Benchmark</span>
<br />
...
## <span style="font-size: 1.8rem; font-weight: bold; color: #333;">ChEF</span>
