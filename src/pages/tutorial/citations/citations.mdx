...
#### <span style="font-size: 1.3rem; font-weight: bold; color: #333;">LAMM</span>
<br />
...
<br />
#### <span style="font-size: 1.3rem; font-weight: bold; color: #333;">ChEF</span>
<br />
<pre style="background-color: #2d2d2d; color: #f8f8f2; padding: 16px; border-radius: 8px;">
<code>
```bibtex
...
<br />
#### <span style="font-size: 1.3rem; font-weight: bold; color: #333;">Octavius</span>
<br />
<pre style="background-color: #2d2d2d; color: #f8f8f2; padding: 16px; border-radius: 8px;">
<code>
```bibtex
